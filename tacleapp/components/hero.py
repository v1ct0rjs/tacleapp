...
def hero() -> rx.Component:
    social_buttons_data = [
        {"name": "Beatport",   "icon": "TBG-PrimaryIcon-White.svg", "href": "https://..."},
        {"name": "Spotify",    "icon": "spotify-white-icon.svg",     "href": "https://..."},
        {"name": "SoundCloud", "icon": "soundcloud-white-icon.svg",  "href": "https://..."},
        {"name": "Twitch",     "icon": "twitch-white-icon.svg",      "href": "https://..."},
    ]
