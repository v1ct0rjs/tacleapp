...
def contact() -> rx.Component:
    ...
    return rx.box(
        rx.container(
                    ...
                    rx.form(
                        rx.flex(
                            ...
                            rx.button(
                                ...
                                type="submit",
                                size="3",
                                disabled=State.form_sending,
                                class_name="w-full bg-red-500 hover:bg-red-600 text-white font-bold border-0 tracking-wider disabled:opacity-60 disabled:cursor-not-allowed"
                            ),
                            direction="column",
                            spacing="4"
                        ),
            ...
            rx.box(
                rx.text(f"© {current_year} 10TACLE. All rights reserved.", size="2", class_name="text-gray-500 text-center"),
